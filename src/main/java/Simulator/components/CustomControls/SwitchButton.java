package Simulator.components.CustomControls;
...
public class SwitchButton extends StackPane {
    ...
    private String buttonStyleOff = "-fx-effect: dropshadow(three-pass-box, rgba(0,0,0,0.2), 0.2, 0.0, 0.0, 2); -fx-background-color: GREY;";
        ...
        EventHandler<Event> click = new EventHandler<Event>() {
            ...
            public void handle(Event e) {
                if (state) {
                    ...
                    setAlignment(button, Pos.CENTER_LEFT);
                    state = false;
                    Classroom.setEnableFramework(false);
                } else {
                    button.setStyle(buttonStyleOn);
                    back.setFill(Color.valueOf("#80C49E"));
                    setAlignment(button, Pos.CENTER_RIGHT);
                    state = true;
                    Classroom.setEnableFramework(true);
                }
            }
        };
